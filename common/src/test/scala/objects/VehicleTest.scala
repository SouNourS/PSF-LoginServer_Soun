...
class VehicleControlShieldsNotChargingDamagedTest extends ActorTest {
  ...
  val p_source = PlayerSource( Player(Avatar(0L, "TestTarget", PlanetSideEmpire.NC, CharacterGender.Female, 1, CharacterVoice.Mute)) )
...
object VehicleTest {
  ...
  val avatar1 = Avatar(0L, "test1", PlanetSideEmpire.TR, CharacterGender.Male, 0, CharacterVoice.Mute)
  val avatar2 = Avatar(0L, "test2", PlanetSideEmpire.TR, CharacterGender.Male, 0, CharacterVoice.Mute)
}
