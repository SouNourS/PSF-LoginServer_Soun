...
class ResistanceCalculationsTests extends Specification {
  ...
  "ResistanceCalculations" should {
    ...
    "discern mechanized infantry targets" in {
      val target = Player(Avatar(0L, "TestCharacter", PlanetSideEmpire.TR, CharacterGender.Male, 0, CharacterVoice.Mute))
...
class ResolutionCalculationsTests extends Specification {
  ...
  "ResolutionCalculations" should {
    ...
    val player2 = Player(Avatar(0L, "TestCharacter2", PlanetSideEmpire.TR, CharacterGender.Male, 0, CharacterVoice.Mute))
...
class DamageModelTests extends Specification {
  ...
  "DamageModel" should {
    ...
    "resolve infantry targets" in {
      val tplayer = Player(Avatar(0L, "TestCharacter2", PlanetSideEmpire.TR, CharacterGender.Male, 0, CharacterVoice.Mute))
      tplayer.Spawn
