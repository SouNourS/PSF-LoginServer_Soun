...
class PlayerAvatarTest extends Specification {
  "PlayerAvatar" should {
    "constructor (default)" in {
      ...
      player.sex mustEqual CharacterGender.Male
      player.voice mustEqual 0
      player.face mustEqual 0
    }

    "constructor(GUID, String, PlanetSideEmpire, Int, Int)" in {
      val player : PlayerAvatar = PlayerAvatar(2, "Chord", PlanetSideEmpire.VS, CharacterGender.Male, 2, 3)
    ...
    "setExoSuitType / getExoSuitType == 'agile exo-suit'" in {
      ...
      val (changed, _) = player.setExoSuitType(ExoSuitType.Agile)
    ...
    "setExoSuitType / getExoSuitType (fails, invalid exo-suit)" in {
      ...
      val (changed, _) = player.setExoSuitType(ExoSuitType.Standard)
    ...
    "getMaxPersonalArmor / getMaxPersonalArmor" in {
      val player : PlayerAvatar = PlayerAvatar(0)
    ...
    "setExoSuitType / getExoSuitType" in {
      ...
      player.getExoSuitType mustEqual ExoSuitType.Agile
      player.getMaxPersonalArmor mustEqual 50
      player.getMaxPersonalArmor mustEqual 50
      player.setExoSuitType(ExoSuitType.Agile)
    ...
    "setPersonalArmor (pass)" in {
      ...
      player.getMaxPersonalArmor mustEqual 25
    }
    ...
    "setPersonalArmor / player.getMaxPersonalArmor (too high)" in {
      ...
      player.getMaxPersonalArmor mustEqual 50
      player.getMaxPersonalArmor mustEqual player.getMaxPersonalArmor
    }
    ...
    "setExoSuitType (dropped wrong-sized equipment)" in {
      val player : PlayerAvatar = PlayerAvatar(0)
      val beamer : Tool = Tool(1, 140)
      player.setExoSuitType(ExoSuitType.Agile) //agile exo-suit, which has holster 1 for pistols
      ...
      val (changed, discard) = player.setExoSuitType(ExoSuitType.Agile) //standard exo-suit, which blocks holster 1
      changed mustEqual true
    ...
    "getUsedHolster (no equipment, do not draw holster)" in {
      val player : PlayerAvatar = PlayerAvatar(0)
      player.setExoSuitType(ExoSuitType.Agile) //just to make holsters available
      player.getUsedHolster mustEqual 255
    ...
    "getUsedHolster (exo-suit changes; put away holster)" in {
      ...
      var (changed, dropped) = player.setExoSuitType(ExoSuitType.Agile)
      changed mustEqual true
    ...
    "getUsedHolster (exo-suit changes; put away holster; dropped equipment)" in {
      ...
      val (changed, dropped) = player.setExoSuitType(ExoSuitType.Agile)
      changed mustEqual true
  ...
  "PlayerMasterList (class)" should {
    ...
    "getWorldPopulation" in {
      val masterList = new PlayerMasterList
      masterList.addPlayer( PlayerAvatar(0, "s1", PlanetSideEmpire.VS, CharacterGender.Male, 2, 3) )
      masterList.addPlayer( PlayerAvatar(1, "s2", PlanetSideEmpire.VS, CharacterGender.Male, 2, 3) )
      masterList.addPlayer( PlayerAvatar(2, "s3", PlanetSideEmpire.TR, CharacterGender.Male, 2, 3) )
      masterList.addPlayer( PlayerAvatar(3, "s4", PlanetSideEmpire.TR, CharacterGender.Male, 2, 3) )
      masterList.addPlayer( PlayerAvatar(4, "s5", PlanetSideEmpire.TR, CharacterGender.Male, 2, 3) )
      masterList.addPlayer( PlayerAvatar(5, "s6", PlanetSideEmpire.NC, CharacterGender.Male, 2, 3) )
  ...
  "PlayerMasterList (object)" should {
    ...
    "everything" in {
      ...
      val id4 : Int = 3
      val player1 : PlayerAvatar = PlayerAvatar(id1, "s1", PlanetSideEmpire.VS, CharacterGender.Male, 2, 3)
      val player2 : PlayerAvatar = PlayerAvatar(id2, "s2", PlanetSideEmpire.TR, CharacterGender.Male, 2, 3)
      val player3 : PlayerAvatar = PlayerAvatar(id3, "s3", PlanetSideEmpire.NC, CharacterGender.Male, 2, 3)
      val player4 : PlayerAvatar = PlayerAvatar(id4, "s4", PlanetSideEmpire.TR, CharacterGender.Male, 2, 3)
