...
import net.psforever.packet.game.{PlanetSideGUID, _}
...
//    "CharacterInfoMessage" should {
//      val string = hex"14 0F 00 00 00 10 27 00  00 C1 D8 7A 02 4B 00 26 5C B0 80 00 "
//
//      "decode" in {
//        PacketCoding.DecodePacket(string).require match {
//          case CharacterInfoMessage(zoneId : PlanetSideZoneID,charId : Long,guid : PlanetSideGUID,finished : Boolean,secondsSinceLastLogin : Long) =>
//            zoneId mustEqual PlanetSideZoneID(10000)
//            charId mustEqual 41605313
//            guid mustEqual PlanetSideGUID(75)
//            finished mustEqual false
//            secondsSinceLastLogin mustEqual 6404428
//          case default =>
//            ko
//        }
//      }
//
//      "encode" in {
//        val msg = CharacterInfoMessage(PlanetSideZoneID(10000),41605313,PlanetSideGUID(75),false,6404428)
