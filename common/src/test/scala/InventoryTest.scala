...
class InventoryTest extends Specification {
  "InventoryItem2" should {
    "constructor" in {
      val beamer = Tool(0, 140)
      val invItem : InventoryItem2 = InventoryItem2(beamer, 2, 5)
    ...
    "constructor (failure)" in {
      InventoryItem2(null, 2, 5) must throwA[IllegalArgumentException]
    }
    ...
    "{object}.toString" in {
      val beamer = Tool(0, 140)
      val obj : InventoryItem2 = InventoryItem2(beamer, 2, 5)
      obj.toString mustEqual "<{beamer-energy_cell(0/16)-fire:0}>"
    }

    "InventoryItem2.toString(object)" in {
      val beamer = Tool(0, 140)
      val obj : InventoryItem2 = InventoryItem2(beamer, 2, 5)
      InventoryItem2.toString(obj) mustEqual "<{beamer-energy_cell(0/16)-fire:0}>"
    }
  }
