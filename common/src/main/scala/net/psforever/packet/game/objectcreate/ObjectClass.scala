...
object ObjectClass {
  ...
  def selectDataDetailedCodec(objClass : Int) : Codec[ConstructorData.genericPattern] =
    (objClass : @switch) match {
      ...
      case ObjectClass.nchev_falcon => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.nchev_scattercannon => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.nchev_sparrow => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      ...
      case ObjectClass.trhev_burster => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.trhev_dualcycler => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.trhev_pounder => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      ...
      case ObjectClass.vshev_comet => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.vshev_starfire => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
      case ObjectClass.vshev_quasar => ConstructorData.genericCodec(DetailedWeaponData.codec(0), "weapon")
  ...
  def selectDataCodec(objClass : Int) : Codec[ConstructorData.genericPattern] =
    (objClass : @switch) match {
      ...
      case ObjectClass.nchev_falcon => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.nchev_scattercannon => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.nchev_sparrow => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      ...
      case ObjectClass.trhev_burster => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.trhev_dualcycler => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.trhev_pounder => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      ...
      case ObjectClass.vshev_comet => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.vshev_quasar => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
      case ObjectClass.vshev_starfire => ConstructorData.genericCodec(WeaponData.codec(0), "weapon")
