...
//    spiker_projectile.Damage1_min = 20
  ...
  private def init_tools() : Unit = {
    ...
    trhev_pounder.ProjectileTypes += pounder_projectile_enh
    trhev_pounder.ProjectileTypes += pounder_projectile_enh
    trhev_pounder.FireModes += new FireModeDefinition //explode on contact
    ...
    trhev_pounder.FireModes(1).AmmoTypeIndices += 1
    ...
    trhev_pounder.FireModes(2).AmmoTypeIndices += 2
    ...
    trhev_pounder.FireModes(3).AmmoTypeIndices += 3
    ...
    trhev_pounder.FireModes(4).AmmoTypeIndices += 4
    ...
    trhev_pounder.FireModes(5).AmmoTypeIndices += 5
