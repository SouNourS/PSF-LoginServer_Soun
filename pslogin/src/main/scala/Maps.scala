...
//    Building5()
  ...
  val map4 = new ZoneMap("map04") {
    ...
    def Building6() : Unit = { // Name: Baal Type: tech_plant GUID: 42, MapID: 6
      ...
      LocalObject(978, IFFLock.Constructor(Vector3(1002.173f, 5484.276f, 74.042f), Vector3(0, 0, 45)))
      DoorToLock(651, 978)
    ...
    def Building14() : Unit = { // Name: Marduk Type: tech_plant GUID: 45, MapID: 14
      ...
      LocalObject(979, IFFLock.Constructor(Vector3(3179.093f, 2275.998f, 72.20319f), Vector3(0, 0, 1)))
      DoorToLock(652, 979)
    ...
    def Building9() : Unit = { // Name: Girru Type: tech_plant GUID: 48, MapID: 9
      ...
      LocalObject(980, IFFLock.Constructor(Vector3(4344.76f, 5975.819f, 79.21956f), Vector3(0, 0, 272)))
      DoorToLock(653, 980)
    ...
    def Building12() : Unit = { // Name: Kusag Type: tech_plant GUID: 51, MapID: 12
      ...
      LocalObject(981, IFFLock.Constructor(Vector3(6566.565f, 4514.186f, 47.28188f), Vector3(0, 0, 129)))
      DoorToLock(654, 981)
