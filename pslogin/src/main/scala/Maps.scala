...
object Maps {
  ...
  val map2 = new ZoneMap("map02") {
    ...
    def Building10() : Unit = { // Chac -  - GUID 45
      LocalBuilding(45, 10, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3.Zero)))
    }
    Projectiles(this)
  }
...
//    Building5()
    ...
    //      LocalBuilding(7, 5, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(5636f, 6621f, 70f)))) //todo ? change ?
    //    }
    Projectiles(this)
  }
  ...
  val map4 = new ZoneMap("map04") {
    ...
    def Building8() : Unit = { // Name: Enkidu Type: amp_station GUID: 1, MapID: 8
      ...
      LocalObject(1885, VehicleSpawnPad.Constructor(Vector3(3301.713f, 3491.774f, 37.8125f), Vector3(0.0f, 354.375f, 45.0f)))
    ...
    def Building15() : Unit = { // Name: Neti Type: comm_station GUID: 18, MapID: 15
      ...
      LocalObject(1887, VehicleSpawnPad.Constructor(Vector3(4056.803f, 2507.361f, 81.359375f), Vector3(0.0f, 357.1875f, 320.625f)))
    ...
    def Building11() : Unit = { // Name: Irkalla Type: comm_station GUID: 21, MapID: 11
      ...
      LocalObject(1892, VehicleSpawnPad.Constructor(Vector3(4834.85f, 5185.569f, 67.0f), Vector3.z(45.0f)))
    ...
    def Building5() : Unit = { // Name: Akkan Type: comm_station_dsp GUID: 24, MapID: 5
      ...
      LocalObject(282, VehicleSpawnPad.Constructor(Vector3(2762.328f, 4448.856f, 44.75f), Vector3(0.0f, 2.8125f, 0.0f)))
      ...
      LocalObject(1881, VehicleSpawnPad.Constructor(Vector3(2711.786f, 4418.411f, 40.609375f), Vector3(0.0f, 351.5625f, 182.8125f)))
    ...
    def Building7() : Unit = { // Name: Dagon Type: cryo_facility GUID: 27, MapID: 7
      ...
      LocalObject(1880, VehicleSpawnPad.Constructor(Vector3(1762.234f, 5802.075f, 40.5625f), Vector3(0.0f, 348.75f, 92.8125f)))
    ...
    def Building10() : Unit = { // Name: Hanish Type: cryo_facility GUID: 30, MapID: 10
      ...
      LocalObject(1886, VehicleSpawnPad.Constructor(Vector3(3674.315f, 5459.119f, 89.0f), Vector3.Zero))
    ...
    def Building16() : Unit = { // Name: Zaqar Type: cryo_facility GUID: 33, MapID: 16
      ...
      LocalObject(1891, VehicleSpawnPad.Constructor(Vector3(4762.881f, 2064.315f, 75.375f), Vector3.z(272.8125f)))
    ...
    def Building13() : Unit = { // Name: Lahar Type: cryo_facility GUID: 36, MapID: 13
      ...
      LocalObject(1896, VehicleSpawnPad.Constructor(Vector3(7070.699f, 5376.181f, 38.6875f), Vector3.z(135.0f)))
    ...
    def Building6() : Unit = { // Name: Baal Type: tech_plant GUID: 42, MapID: 6
      ...
      LocalObject(1879, VehicleSpawnPad.Constructor(Vector3(955.0065f, 5538.954f, 52.578125f), Vector3(0.0f, 2.8125f, 135.0f)))
    ...
    def Building14() : Unit = { // Name: Marduk Type: tech_plant GUID: 45, MapID: 14
      ...
      LocalObject(1882, VehicleSpawnPad.Constructor(Vector3(3107.182f, 2282.565f, 50.734375f), Vector3.z(92.8125f)))
    ...
    def Building9() : Unit = { // Name: Girru Type: tech_plant GUID: 48, MapID: 9
      ...
      LocalObject(1888, VehicleSpawnPad.Constructor(Vector3(4336.939f, 5904.034f, 58.0f), Vector3.Zero))
    ...
    def Building12() : Unit = { // Name: Kusag Type: tech_plant GUID: 51, MapID: 12
      ...
      LocalObject(1895, VehicleSpawnPad.Constructor(Vector3(6616.012f, 4566.809f, 25.8125f), Vector3.z(278.4375f)))
  ...
  val map5 = new ZoneMap("map05") {
    ...
    def Building12() : Unit = { // Bel -  - GUID 23
      LocalBuilding(23, 12, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3.Zero)))
    }
    Projectiles(this)
  }
  ...
  val map7 = new ZoneMap("map07") {
    ...
    def Building17() : Unit = { // Ran -  - GUID 34
      LocalBuilding(34, 17, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3.Zero)))
    }
    Building7()
    def Building7() : Unit = { // Eisa -  - GUID 47
      LocalBuilding(47, 7, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3.Zero)))
    }
    Projectiles(this)
  }
...
//        }
  ...
  val ugd03 = new ZoneMap("ugd03") {
    ...
    def Building10359() : Unit = { // Red SE (ID: 104)
      LocalBuilding(104, 10359, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(5636f, 6621f, 70f)))) //todo ? change ?
    }
    Projectiles(this)
  }
