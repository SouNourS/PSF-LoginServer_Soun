...
object Map10 {
  ...
  val ZoneMap = new ZoneMap("map10") {
    ...
    def Building13(): Unit = { // Name: Sungrey Type: amp_station GUID: 1, MapID: 13
      LocalBuilding(1, 13, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(4686f, 5546f, 72.05738f))))
      ...
      LocalObject(1724, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1725, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1726, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1727, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1728, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(1729, Terminal.Constructor(order_terminal), owning_building_guid = 1)
      LocalObject(2446, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2450, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2451, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2452, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2453, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2454, Terminal.Constructor(spawn_terminal), owning_building_guid = 1)
      LocalObject(2651, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 1)
      LocalObject(1632, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4616.341f, 5499.374f, 70.00238f), Vector3(0, 0, 91)), owning_building_guid = 1, terminal_guid = 2651)
      ...
      LocalObject(1651, ProximityTerminal.Constructor(medical_terminal, Vector3(4680.528f, 5554.541f, 57.25738f)), owning_building_guid = 1)
      LocalObject(1652, ProximityTerminal.Constructor(medical_terminal, Vector3(4685.621f, 5523.955f, 77.25738f)), owning_building_guid = 1)
      LocalObject(1909, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4629.061f, 5573.595f, 82.72338f)), owning_building_guid = 1)
      LocalObject(1910, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1921, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4665.233f, 5489.106f, 80.56238f)), owning_building_guid = 1)
      LocalObject(1922, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1930, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4706.692f, 5595.021f, 80.56238f)), owning_building_guid = 1)
      LocalObject(1931, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(1933, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4759.628f, 5553.014f, 80.58538f)), owning_building_guid = 1)
      LocalObject(1934, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 1)
      LocalObject(2241, ProximityTerminal.Constructor(repair_silo, Vector3(4684.573f, 5475.918f, 71.45738f)), owning_building_guid = 1)
      LocalObject(2242, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(2245, ProximityTerminal.Constructor(repair_silo, Vector3(4686.694f, 5608.322f, 71.45738f)), owning_building_guid = 1)
      LocalObject(2246, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 1)
      LocalObject(1566, FacilityTurret.Constructor(manned_turret, Vector3(4579.77f, 5467.218f, 80.76538f)), owning_building_guid = 1)
      TurretToWeapon(1566, 5000)
      LocalObject(1567, FacilityTurret.Constructor(manned_turret, Vector3(4582.458f, 5620.663f, 80.76538f)), owning_building_guid = 1)
      TurretToWeapon(1567, 5001)
      LocalObject(1568, FacilityTurret.Constructor(manned_turret, Vector3(4645.869f, 5621.774f, 80.76538f)), owning_building_guid = 1)
      TurretToWeapon(1568, 5002)
      LocalObject(1572, FacilityTurret.Constructor(manned_turret, Vector3(4781.417f, 5463.727f, 80.76538f)), owning_building_guid = 1)
      TurretToWeapon(1572, 5003)
      LocalObject(1573, FacilityTurret.Constructor(manned_turret, Vector3(4784.104f, 5617.134f, 80.76538f)), owning_building_guid = 1)
      TurretToWeapon(1573, 5004)
      LocalObject(1574, FacilityTurret.Constructor(manned_turret, Vector3(4784.684f, 5523.266f, 80.76538f)), owning_building_guid = 1)
    ...
    def Building49(): Unit = { // Name: Verica Type: amp_station GUID: 4, MapID: 49
      LocalBuilding(4, 49, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(4902f, 3534f, 47.26933f))))
      ...
      LocalObject(1736, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1737, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1738, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1739, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1740, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(1741, Terminal.Constructor(order_terminal), owning_building_guid = 4)
      LocalObject(2456, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2457, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2458, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2459, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2460, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2461, Terminal.Constructor(spawn_terminal), owning_building_guid = 4)
      LocalObject(2653, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 4)
      LocalObject(1634, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4970.835f, 3581.835f, 45.21432f), Vector3(0, 0, -90)), owning_building_guid = 4, terminal_guid = 2653)
      ...
      LocalObject(1653, ProximityTerminal.Constructor(medical_terminal, Vector3(4901.994f, 3556.048f, 52.46933f)), owning_building_guid = 4)
      LocalObject(1654, ProximityTerminal.Constructor(medical_terminal, Vector3(4907.62f, 3525.556f, 32.46933f)), owning_building_guid = 4)
      LocalObject(1936, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4828.505f, 3525.702f, 55.79733f)), owning_building_guid = 4)
      LocalObject(1937, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1939, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4882.167f, 3484.625f, 55.77433f)), owning_building_guid = 4)
      LocalObject(1940, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1942, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4921.771f, 3591.248f, 55.77433f)), owning_building_guid = 4)
      LocalObject(1943, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(1945, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4959.412f, 3507.403f, 57.93533f)), owning_building_guid = 4)
      LocalObject(1946, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 4)
      LocalObject(2253, ProximityTerminal.Constructor(repair_silo, Vector3(4902.204f, 3604.096f, 46.66933f)), owning_building_guid = 4)
      LocalObject(2254, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(2257, ProximityTerminal.Constructor(repair_silo, Vector3(4902.393f, 3471.675f, 46.66933f)), owning_building_guid = 4)
      LocalObject(2258, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 4)
      LocalObject(1575, FacilityTurret.Constructor(manned_turret, Vector3(4802.934f, 3555.008f, 55.97733f)), owning_building_guid = 4)
      TurretToWeapon(1575, 5006)
      LocalObject(1576, FacilityTurret.Constructor(manned_turret, Vector3(4805.152f, 3461.165f, 55.97733f)), owning_building_guid = 4)
      TurretToWeapon(1576, 5007)
      LocalObject(1577, FacilityTurret.Constructor(manned_turret, Vector3(4805.162f, 3614.595f, 55.97733f)), owning_building_guid = 4)
      TurretToWeapon(1577, 5008)
      LocalObject(1580, FacilityTurret.Constructor(manned_turret, Vector3(4943.447f, 3458.938f, 55.97733f)), owning_building_guid = 4)
      TurretToWeapon(1580, 5009)
      LocalObject(1583, FacilityTurret.Constructor(manned_turret, Vector3(5006.829f, 3461.156f, 55.97733f)), owning_building_guid = 4)
      TurretToWeapon(1583, 5010)
      LocalObject(1584, FacilityTurret.Constructor(manned_turret, Vector3(5006.839f, 3614.624f, 55.97733f)), owning_building_guid = 4)
    ...
    def Building44(): Unit = { // Name: bunker_gauntlet Type: bunker_gauntlet GUID: 7, MapID: 44
      LocalBuilding(7, 44, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(4418f, 2340f, 47.18137f))))
    ...
    def Building41(): Unit = { // Name: bunker_lg Type: bunker_lg GUID: 8, MapID: 41
      LocalBuilding(8, 41, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(3754f, 5092f, 57.63699f))))
    ...
    def Building37(): Unit = { // Name: bunker_lg Type: bunker_lg GUID: 9, MapID: 37
      LocalBuilding(9, 37, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(4288f, 2540f, 47.49414f))))
    ...
    def Building42(): Unit = { // Name: bunker_lg Type: bunker_lg GUID: 10, MapID: 42
      LocalBuilding(10, 42, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(4570f, 5668f, 69.13481f))))
    ...
    def Building43(): Unit = { // Name: bunker_lg Type: bunker_lg GUID: 11, MapID: 43
      LocalBuilding(11, 43, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(4734f, 6182f, 69.42805f))))
    ...
    def Building40(): Unit = { // Name: bunker_lg Type: bunker_lg GUID: 12, MapID: 40
      LocalBuilding(12, 40, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(6116f, 5328f, 61.81373f))))
    ...
    def Building36(): Unit = { // Name: bunker_sm Type: bunker_sm GUID: 13, MapID: 36
      LocalBuilding(13, 36, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(3390f, 2748f, 69.11893f))))
    ...
    def Building45(): Unit = { // Name: bunker_sm Type: bunker_sm GUID: 14, MapID: 45
      LocalBuilding(14, 45, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(4006f, 5186f, 46.02675f))))
    ...
    def Building50(): Unit = { // Name: bunker_sm Type: bunker_sm GUID: 15, MapID: 50
      LocalBuilding(15, 50, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(6156f, 2592f, 41.59035f))))
    ...
    def Building38(): Unit = { // Name: bunker_sm Type: bunker_sm GUID: 16, MapID: 38
      LocalBuilding(16, 38, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(6168f, 3532f, 37.92495f))))
    ...
    def Building39(): Unit = { // Name: bunker_sm Type: bunker_sm GUID: 17, MapID: 39
      LocalBuilding(17, 39, FoundationBuilder(Building.Structure(StructureType.Bunker, Vector3(6550f, 4324f, 56.2203f))))
    ...
    def Building6(): Unit = { // Name: Cetan Type: comm_station GUID: 18, MapID: 6
      LocalBuilding(18, 6, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(3500f, 2544f, 47.96331f))))
      ...
      LocalObject(1687, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1688, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1689, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1690, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1694, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1695, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(1696, Terminal.Constructor(order_terminal), owning_building_guid = 18)
      LocalObject(2424, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2425, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2426, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2427, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2428, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2429, Terminal.Constructor(spawn_terminal), owning_building_guid = 18)
      LocalObject(2648, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 18)
      LocalObject(1625, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3496.973f, 2610.949f, 46.69231f), Vector3(0, 0, 232)), owning_building_guid = 18, terminal_guid = 2648)
      ...
      LocalObject(1643, ProximityTerminal.Constructor(medical_terminal, Vector3(3518.521f, 2521.698f, 48.16331f)), owning_building_guid = 18)
      LocalObject(1644, ProximityTerminal.Constructor(medical_terminal, Vector3(3532.547f, 2607.017f, 30.66331f)), owning_building_guid = 18)
      LocalObject(1882, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3451.174f, 2575.884f, 56.40431f)), owning_building_guid = 18)
      LocalObject(1883, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 18)
      LocalObject(2213, ProximityTerminal.Constructor(repair_silo, Vector3(3437.591f, 2524.656f, 47.71331f)), owning_building_guid = 18)
      LocalObject(2214, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 18)
      LocalObject(2217, ProximityTerminal.Constructor(repair_silo, Vector3(3563.553f, 2562.778f, 47.71331f)), owning_building_guid = 18)
      LocalObject(2218, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 18)
      LocalObject(1537, FacilityTurret.Constructor(manned_turret, Vector3(3418.225f, 2529.16f, 56.67131f)), owning_building_guid = 18)
      TurretToWeapon(1537, 5012)
      LocalObject(1538, FacilityTurret.Constructor(manned_turret, Vector3(3425.674f, 2589.672f, 56.67131f)), owning_building_guid = 18)
      TurretToWeapon(1538, 5013)
      LocalObject(1541, FacilityTurret.Constructor(manned_turret, Vector3(3492.433f, 2436.014f, 56.67131f)), owning_building_guid = 18)
      TurretToWeapon(1541, 5014)
      LocalObject(1542, FacilityTurret.Constructor(manned_turret, Vector3(3507.879f, 2652.229f, 56.67131f)), owning_building_guid = 18)
      TurretToWeapon(1542, 5015)
      LocalObject(1543, FacilityTurret.Constructor(manned_turret, Vector3(3574.567f, 2498.691f, 56.67131f)), owning_building_guid = 18)
      TurretToWeapon(1543, 5016)
      LocalObject(1544, FacilityTurret.Constructor(manned_turret, Vector3(3582.023f, 2559.228f, 56.67131f)), owning_building_guid = 18)
    ...
    def Building12(): Unit = { // Name: Qumu Type: comm_station GUID: 21, MapID: 12
      LocalBuilding(21, 12, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(3904f, 5172f, 46.34075f))))
      ...
      LocalObject(1700, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1701, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1702, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1703, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1704, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1705, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(1706, Terminal.Constructor(order_terminal), owning_building_guid = 21)
      LocalObject(2430, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2431, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2432, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2433, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2434, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2435, Terminal.Constructor(spawn_terminal), owning_building_guid = 21)
      LocalObject(2649, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 21)
      LocalObject(1626, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3893.992f, 5238.266f, 45.06975f), Vector3(0, 0, 226)), owning_building_guid = 21, terminal_guid = 2649)
      ...
      LocalObject(1645, ProximityTerminal.Constructor(medical_terminal, Vector3(3924.751f, 5151.756f, 46.54075f)), owning_building_guid = 21)
      LocalObject(1646, ProximityTerminal.Constructor(medical_terminal, Vector3(3929.781f, 5238.073f, 29.04075f)), owning_building_guid = 21)
      LocalObject(1885, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3852.109f, 5198.605f, 54.78175f)), owning_building_guid = 21)
      LocalObject(1886, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 21)
      LocalObject(2221, ProximityTerminal.Constructor(repair_silo, Vector3(3843.955f, 5146.239f, 46.09075f)), owning_building_guid = 21)
      LocalObject(2222, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 21)
      LocalObject(2225, ProximityTerminal.Constructor(repair_silo, Vector3(3965.242f, 5197.318f, 46.09075f)), owning_building_guid = 21)
      LocalObject(2226, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 21)
      LocalObject(1547, FacilityTurret.Constructor(manned_turret, Vector3(3824.224f, 5148.694f, 55.04875f)), owning_building_guid = 21)
      TurretToWeapon(1547, 5018)
      LocalObject(1548, FacilityTurret.Constructor(manned_turret, Vector3(3825.307f, 5209.653f, 55.04875f)), owning_building_guid = 21)
      TurretToWeapon(1548, 5019)
      LocalObject(1550, FacilityTurret.Constructor(manned_turret, Vector3(3900.523f, 5280.459f, 55.04875f)), owning_building_guid = 21)
      TurretToWeapon(1550, 5020)
      LocalObject(1551, FacilityTurret.Constructor(manned_turret, Vector3(3907.761f, 5063.814f, 55.04875f)), owning_building_guid = 21)
      TurretToWeapon(1551, 5021)
      LocalObject(1553, FacilityTurret.Constructor(manned_turret, Vector3(3982.895f, 5134.734f, 55.04875f)), owning_building_guid = 21)
      TurretToWeapon(1553, 5022)
      LocalObject(1554, FacilityTurret.Constructor(manned_turret, Vector3(3983.982f, 5195.718f, 55.04875f)), owning_building_guid = 21)
    ...
    def Building5(): Unit = { // Name: Azeban Type: comm_station_dsp GUID: 24, MapID: 5
      LocalBuilding(24, 5, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(6260f, 5234f, 61.88216f))))
      ...
      LocalObject(256, Terminal.Constructor(dropship_vehicle_terminal), owning_building_guid = 24)
      LocalObject(255, VehicleSpawnPad.Constructor(dropship_pad_doors, Vector3(6328.328f, 5358.856f, 61.91016f), Vector3(0, 0, 90)), owning_building_guid = 24, terminal_guid = 256)
      LocalObject(1774, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1775, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1776, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1777, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1778, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1779, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1780, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(1781, Terminal.Constructor(order_terminal), owning_building_guid = 24)
      LocalObject(2476, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2477, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2478, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2479, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2480, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2481, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2482, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2483, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2484, Terminal.Constructor(spawn_terminal), owning_building_guid = 24)
      LocalObject(2656, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 24)
      LocalObject(1639, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6277.786f, 5328.411f, 60.51116f), Vector3(0, 0, 180)), owning_building_guid = 24, terminal_guid = 2656)
      ...
      LocalObject(1658, ProximityTerminal.Constructor(medical_terminal, Vector3(6260.863f, 5205.013f, 61.98215f)), owning_building_guid = 24)
      LocalObject(1659, ProximityTerminal.Constructor(medical_terminal, Vector3(6324.444f, 5263.62f, 44.48215f)), owning_building_guid = 24)
      LocalObject(1978, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6241.153f, 5327.398f, 70.29216f)), owning_building_guid = 24)
      LocalObject(1979, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 24)
      LocalObject(1981, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6257.514f, 5281.467f, 67.57616f)), owning_building_guid = 24)
      LocalObject(1982, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 24)
      LocalObject(1984, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6309.804f, 5245.901f, 74.75816f)), owning_building_guid = 24)
      LocalObject(1985, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 24)
      LocalObject(1987, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6345.071f, 5262.159f, 70.30516f)), owning_building_guid = 24)
      LocalObject(1988, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 24)
      LocalObject(2277, ProximityTerminal.Constructor(repair_silo, Vector3(6198.643f, 5272.241f, 61.63216f)), owning_building_guid = 24)
      LocalObject(2278, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 24)
      LocalObject(2281, ProximityTerminal.Constructor(repair_silo, Vector3(6368.57f, 5275.151f, 61.63216f)), owning_building_guid = 24)
      LocalObject(2282, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 24)
      LocalObject(1605, FacilityTurret.Constructor(manned_turret, Vector3(6186.401f, 5307.113f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1605, 5024)
      LocalObject(1606, FacilityTurret.Constructor(manned_turret, Vector3(6187.554f, 5153.565f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1606, 5025)
      LocalObject(1608, FacilityTurret.Constructor(manned_turret, Vector3(6231.445f, 5353.667f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1608, 5026)
      LocalObject(1610, FacilityTurret.Constructor(manned_turret, Vector3(6290.428f, 5152.396f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1610, 5027)
      LocalObject(1611, FacilityTurret.Constructor(manned_turret, Vector3(6291.449f, 5412.154f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1611, 5028)
      LocalObject(1613, FacilityTurret.Constructor(manned_turret, Vector3(6332.537f, 5193.011f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1613, 5029)
      LocalObject(1614, FacilityTurret.Constructor(manned_turret, Vector3(6379.619f, 5410.985f, 70.49016f)), owning_building_guid = 24)
      TurretToWeapon(1614, 5030)
      LocalObject(1615, FacilityTurret.Constructor(manned_turret, Vector3(6380.773f, 5242.733f, 70.49016f)), owning_building_guid = 24)
    ...
    def Building8(): Unit = { // Name: Ikanam Type: cryo_facility GUID: 27, MapID: 8
      LocalBuilding(27, 8, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(2694f, 2352f, 57.10244f))))
      ...
      LocalObject(203, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(204, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(205, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(206, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(207, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(208, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(209, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(210, Terminal.Constructor(cert_terminal), owning_building_guid = 27)
      LocalObject(1667, Terminal.Constructor(order_terminal), owning_building_guid = 27)
      LocalObject(1668, Terminal.Constructor(order_terminal), owning_building_guid = 27)
      LocalObject(1669, Terminal.Constructor(order_terminal), owning_building_guid = 27)
      LocalObject(1670, Terminal.Constructor(order_terminal), owning_building_guid = 27)
      LocalObject(2410, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2411, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2412, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2413, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2414, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2415, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2416, Terminal.Constructor(spawn_terminal), owning_building_guid = 27)
      LocalObject(2646, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 27)
      LocalObject(1623, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(2717.989f, 2288.724f, 55.24944f), Vector3(0, 0, -90)), owning_building_guid = 27, terminal_guid = 2646)
      ...
      LocalObject(141, ProximityTerminal.Constructor(adv_med_terminal, Vector3(2695.983f, 2344.892f, 56.91244f)), owning_building_guid = 27)
      LocalObject(1641, ProximityTerminal.Constructor(medical_terminal, Vector3(2721.642f, 2355.952f, 47.10244f)), owning_building_guid = 27)
      LocalObject(1858, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2675.883f, 2290.061f, 67.39544f)), owning_building_guid = 27)
      LocalObject(1859, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 27)
      LocalObject(1861, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2679.101f, 2405.651f, 65.44444f)), owning_building_guid = 27)
      LocalObject(1862, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 27)
      LocalObject(1864, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2692.198f, 2282.777f, 65.45444f)), owning_building_guid = 27)
      LocalObject(1865, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 27)
      LocalObject(1867, ProximityTerminal.Constructor(pad_landing_frame, Vector3(2695.323f, 2397.253f, 67.43444f)), owning_building_guid = 27)
      LocalObject(1868, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 27)
      LocalObject(2197, ProximityTerminal.Constructor(repair_silo, Vector3(2658.525f, 2267.154f, 56.85244f)), owning_building_guid = 27)
      LocalObject(2198, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 27)
      LocalObject(2201, ProximityTerminal.Constructor(repair_silo, Vector3(2746.53f, 2367.861f, 56.85244f)), owning_building_guid = 27)
      LocalObject(2202, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 27)
      LocalObject(1521, FacilityTurret.Constructor(manned_turret, Vector3(2622.392f, 2432.472f, 65.50444f)), owning_building_guid = 27)
      TurretToWeapon(1521, 5032)
      LocalObject(1522, FacilityTurret.Constructor(manned_turret, Vector3(2622.4f, 2255.379f, 65.50444f)), owning_building_guid = 27)
      TurretToWeapon(1522, 5033)
      LocalObject(1523, FacilityTurret.Constructor(manned_turret, Vector3(2715.665f, 2433.605f, 65.50444f)), owning_building_guid = 27)
      TurretToWeapon(1523, 5034)
      LocalObject(1524, FacilityTurret.Constructor(manned_turret, Vector3(2757.626f, 2255.371f, 65.50444f)), owning_building_guid = 27)
      TurretToWeapon(1524, 5035)
      LocalObject(1525, FacilityTurret.Constructor(manned_turret, Vector3(2758.813f, 2390.496f, 65.50444f)), owning_building_guid = 27)
      TurretToWeapon(1525, 5036)
      LocalObject(858, ImplantTerminalMech.Constructor, owning_building_guid = 27)
      LocalObject(850, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 27)
      TerminalToInterface(858, 850)
      LocalObject(859, ImplantTerminalMech.Constructor, owning_building_guid = 27)
      LocalObject(851, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 27)
    ...
    def Building11(): Unit = { // Name: Onatha Type: cryo_facility GUID: 30, MapID: 11
      LocalBuilding(30, 11, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(3350f, 5732f, 47.90467f))))
      ...
      LocalObject(211, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(212, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(213, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(214, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(215, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(216, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(217, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(218, Terminal.Constructor(cert_terminal), owning_building_guid = 30)
      LocalObject(1674, Terminal.Constructor(order_terminal), owning_building_guid = 30)
      LocalObject(1675, Terminal.Constructor(order_terminal), owning_building_guid = 30)
      LocalObject(1676, Terminal.Constructor(order_terminal), owning_building_guid = 30)
      LocalObject(1677, Terminal.Constructor(order_terminal), owning_building_guid = 30)
      LocalObject(2417, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2418, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2419, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2420, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2421, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2422, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2423, Terminal.Constructor(spawn_terminal), owning_building_guid = 30)
      LocalObject(2647, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 30)
      LocalObject(1624, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(3373.989f, 5668.724f, 46.05167f), Vector3(0, 0, -90)), owning_building_guid = 30, terminal_guid = 2647)
      ...
      LocalObject(142, ProximityTerminal.Constructor(adv_med_terminal, Vector3(3351.983f, 5724.892f, 47.71467f)), owning_building_guid = 30)
      LocalObject(1642, ProximityTerminal.Constructor(medical_terminal, Vector3(3377.642f, 5735.952f, 37.90467f)), owning_building_guid = 30)
      LocalObject(1870, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3331.883f, 5670.061f, 58.19767f)), owning_building_guid = 30)
      LocalObject(1871, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 30)
      LocalObject(1873, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3335.101f, 5785.651f, 56.24667f)), owning_building_guid = 30)
      LocalObject(1874, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 30)
      LocalObject(1876, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3348.198f, 5662.777f, 56.25667f)), owning_building_guid = 30)
      LocalObject(1877, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 30)
      LocalObject(1879, ProximityTerminal.Constructor(pad_landing_frame, Vector3(3351.323f, 5777.253f, 58.23667f)), owning_building_guid = 30)
      LocalObject(1880, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 30)
      LocalObject(2205, ProximityTerminal.Constructor(repair_silo, Vector3(3314.525f, 5647.154f, 47.65467f)), owning_building_guid = 30)
      LocalObject(2206, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 30)
      LocalObject(2209, ProximityTerminal.Constructor(repair_silo, Vector3(3402.53f, 5747.861f, 47.65467f)), owning_building_guid = 30)
      LocalObject(2210, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 30)
      LocalObject(1528, FacilityTurret.Constructor(manned_turret, Vector3(3278.392f, 5812.472f, 56.30667f)), owning_building_guid = 30)
      TurretToWeapon(1528, 5037)
      LocalObject(1529, FacilityTurret.Constructor(manned_turret, Vector3(3278.4f, 5635.379f, 56.30667f)), owning_building_guid = 30)
      TurretToWeapon(1529, 5038)
      LocalObject(1532, FacilityTurret.Constructor(manned_turret, Vector3(3371.665f, 5813.605f, 56.30667f)), owning_building_guid = 30)
      TurretToWeapon(1532, 5039)
      LocalObject(1535, FacilityTurret.Constructor(manned_turret, Vector3(3413.626f, 5635.371f, 56.30667f)), owning_building_guid = 30)
      TurretToWeapon(1535, 5040)
      LocalObject(1536, FacilityTurret.Constructor(manned_turret, Vector3(3414.813f, 5770.496f, 56.30667f)), owning_building_guid = 30)
      TurretToWeapon(1536, 5041)
      LocalObject(860, ImplantTerminalMech.Constructor, owning_building_guid = 30)
      LocalObject(852, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 30)
      TerminalToInterface(860, 852)
      LocalObject(861, ImplantTerminalMech.Constructor, owning_building_guid = 30)
      LocalObject(853, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 30)
    ...
    def Building9(): Unit = { // Name: Kyoi Type: cryo_facility GUID: 33, MapID: 9
      LocalBuilding(33, 9, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(5556f, 2232f, 62.32201f))))
      ...
      LocalObject(219, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(220, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(221, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(222, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(223, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(224, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(225, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(226, Terminal.Constructor(cert_terminal), owning_building_guid = 33)
      LocalObject(1757, Terminal.Constructor(order_terminal), owning_building_guid = 33)
      LocalObject(1758, Terminal.Constructor(order_terminal), owning_building_guid = 33)
      LocalObject(1759, Terminal.Constructor(order_terminal), owning_building_guid = 33)
      LocalObject(1760, Terminal.Constructor(order_terminal), owning_building_guid = 33)
      LocalObject(2462, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2463, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2464, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2465, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2466, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2467, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2468, Terminal.Constructor(spawn_terminal), owning_building_guid = 33)
      LocalObject(2654, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 33)
      LocalObject(1635, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5620.075f, 2253.766f, 60.46901f), Vector3(0, 0, 182)), owning_building_guid = 33, terminal_guid = 2654)
      ...
      LocalObject(143, ProximityTerminal.Constructor(adv_med_terminal, Vector3(5563.173f, 2233.734f, 62.13201f)), owning_building_guid = 33)
      LocalObject(1655, ProximityTerminal.Constructor(medical_terminal, Vector3(5553.015f, 2259.763f, 52.32201f)), owning_building_guid = 33)
      LocalObject(1948, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5501.862f, 2218.982f, 70.66401f)), owning_building_guid = 33)
      LocalObject(1949, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 33)
      LocalObject(1951, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5510.821f, 2234.902f, 72.65401f)), owning_building_guid = 33)
      LocalObject(1952, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 33)
      LocalObject(1954, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5617.269f, 2211.732f, 72.61501f)), owning_building_guid = 33)
      LocalObject(1955, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 33)
      LocalObject(1957, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5625.118f, 2227.783f, 70.674f)), owning_building_guid = 33)
      LocalObject(1958, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 33)
      LocalObject(2261, ProximityTerminal.Constructor(repair_silo, Vector3(5541.982f, 2285.051f, 62.07201f)), owning_building_guid = 33)
      LocalObject(2262, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 33)
      LocalObject(2265, ProximityTerminal.Constructor(repair_silo, Vector3(5639.556f, 2193.585f, 62.07201f)), owning_building_guid = 33)
      LocalObject(2266, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 33)
      LocalObject(1588, FacilityTurret.Constructor(manned_turret, Vector3(5473.078f, 2163.244f, 70.72401f)), owning_building_guid = 33)
      TurretToWeapon(1588, 5042)
      LocalObject(1589, FacilityTurret.Constructor(manned_turret, Vector3(5475.201f, 2256.5f, 70.72401f)), owning_building_guid = 33)
      TurretToWeapon(1589, 5043)
      LocalObject(1591, FacilityTurret.Constructor(manned_turret, Vector3(5519.79f, 2298.117f, 70.72401f)), owning_building_guid = 33)
      TurretToWeapon(1591, 5044)
      LocalObject(1594, FacilityTurret.Constructor(manned_turret, Vector3(5650.063f, 2157.072f, 70.72401f)), owning_building_guid = 33)
      TurretToWeapon(1594, 5045)
      LocalObject(1595, FacilityTurret.Constructor(manned_turret, Vector3(5654.791f, 2292.215f, 70.72401f)), owning_building_guid = 33)
      TurretToWeapon(1595, 5046)
      LocalObject(862, ImplantTerminalMech.Constructor, owning_building_guid = 33)
      LocalObject(854, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 33)
      TerminalToInterface(862, 854)
      LocalObject(863, ImplantTerminalMech.Constructor, owning_building_guid = 33)
      LocalObject(855, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 33)
    ...
    def Building15(): Unit = { // Name: Xelas Type: cryo_facility GUID: 36, MapID: 15
      LocalBuilding(36, 15, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(6644f, 4402f, 56.31071f))))
      ...
      LocalObject(227, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(228, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(229, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(230, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(231, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(232, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(233, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(234, Terminal.Constructor(cert_terminal), owning_building_guid = 36)
      LocalObject(1788, Terminal.Constructor(order_terminal), owning_building_guid = 36)
      LocalObject(1789, Terminal.Constructor(order_terminal), owning_building_guid = 36)
      LocalObject(1790, Terminal.Constructor(order_terminal), owning_building_guid = 36)
      LocalObject(1791, Terminal.Constructor(order_terminal), owning_building_guid = 36)
      LocalObject(2485, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2486, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2487, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2488, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2489, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2490, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2491, Terminal.Constructor(spawn_terminal), owning_building_guid = 36)
      LocalObject(2657, Terminal.Constructor(vehicle_terminal_combined), owning_building_guid = 36)
      LocalObject(1640, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6711.131f, 4393.475f, 54.45771f), Vector3(0, 0, 208)), owning_building_guid = 36, terminal_guid = 2657)
      ...
      LocalObject(144, ProximityTerminal.Constructor(adv_med_terminal, Vector3(6651.207f, 4400.414f, 56.12071f)), owning_building_guid = 36)
      LocalObject(1660, ProximityTerminal.Constructor(medical_terminal, Vector3(6653.488f, 4428.262f, 46.31071f)), owning_building_guid = 36)
      LocalObject(1990, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6589.634f, 4414.033f, 64.65271f)), owning_building_guid = 36)
      LocalObject(1991, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 36)
      LocalObject(1993, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6604.665f, 4424.413f, 66.64271f)), owning_building_guid = 36)
      LocalObject(1994, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 36)
      LocalObject(1996, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6690.184f, 4356.925f, 66.60371f)), owning_building_guid = 36)
      LocalObject(1997, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 36)
      LocalObject(1999, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6704.274f, 4367.911f, 64.66271f)), owning_building_guid = 36)
      LocalObject(2000, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 36)
      LocalObject(2285, ProximityTerminal.Constructor(repair_silo, Vector3(6654.657f, 4455.828f, 56.06071f)), owning_building_guid = 36)
      LocalObject(2286, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 36)
      LocalObject(2289, ProximityTerminal.Constructor(repair_silo, Vector3(6702.26f, 4330.844f, 56.06071f)), owning_building_guid = 36)
      LocalObject(2290, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 36)
      LocalObject(1618, FacilityTurret.Constructor(manned_turret, Vector3(6539.33f, 4376.553f, 64.71271f)), owning_building_guid = 36)
      TurretToWeapon(1618, 5047)
      LocalObject(1619, FacilityTurret.Constructor(manned_turret, Vector3(6582.118f, 4459.44f, 64.71271f)), owning_building_guid = 36)
      TurretToWeapon(1619, 5048)
      LocalObject(1620, FacilityTurret.Constructor(manned_turret, Vector3(6640.438f, 4477.299f, 64.71271f)), owning_building_guid = 36)
      TurretToWeapon(1620, 5049)
      LocalObject(1621, FacilityTurret.Constructor(manned_turret, Vector3(6695.697f, 4293.42f, 64.71271f)), owning_building_guid = 36)
      TurretToWeapon(1621, 5050)
      LocalObject(1622, FacilityTurret.Constructor(manned_turret, Vector3(6759.189f, 4412.814f, 64.71271f)), owning_building_guid = 36)
      TurretToWeapon(1622, 5051)
      LocalObject(864, ImplantTerminalMech.Constructor, owning_building_guid = 36)
      LocalObject(856, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 36)
      TerminalToInterface(864, 856)
      LocalObject(865, ImplantTerminalMech.Constructor, owning_building_guid = 36)
      LocalObject(857, Terminal.Constructor(implant_terminal_interface), owning_building_guid = 36)
    ...
    def Building7(): Unit = { // Name: Heyoka Type: tech_plant GUID: 43, MapID: 7
      LocalBuilding(43, 7, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(4298f, 2404f, 47.49414f))))
      ...
      LocalObject(145, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 43)
      LocalObject(1628, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4298.07f, 2399.835f, 60.07214f), Vector3(0, 0, 0)), owning_building_guid = 43, terminal_guid = 145)
      LocalObject(146, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 43)
      LocalObject(1629, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4319.088f, 2399.835f, 60.07214f), Vector3(0, 0, 0)), owning_building_guid = 43, terminal_guid = 146)
      LocalObject(1713, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1714, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1715, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(1716, Terminal.Constructor(order_terminal), owning_building_guid = 43)
      LocalObject(2436, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2437, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2438, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2439, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2440, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2441, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2442, Terminal.Constructor(spawn_terminal), owning_building_guid = 43)
      LocalObject(2650, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 43)
      LocalObject(1627, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4249.945f, 2374.339f, 25.03114f), Vector3(0, 0, 0)), owning_building_guid = 43, terminal_guid = 2650)
      ...
      LocalObject(1647, ProximityTerminal.Constructor(medical_terminal, Vector3(4301.059f, 2366.901f, 52.59114f)), owning_building_guid = 43)
      LocalObject(1648, ProximityTerminal.Constructor(medical_terminal, Vector3(4338.444f, 2377.62f, 32.59414f)), owning_building_guid = 43)
      LocalObject(1888, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4236.704f, 2379.661f, 55.68914f)), owning_building_guid = 43)
      LocalObject(1889, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(1891, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4256.98f, 2395.833f, 58.04414f)), owning_building_guid = 43)
      LocalObject(1892, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(1894, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4307.379f, 2339.474f, 62.94114f)), owning_building_guid = 43)
      LocalObject(1895, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(1897, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4323.534f, 2322.628f, 55.70214f)), owning_building_guid = 43)
      LocalObject(1898, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(1900, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4359.987f, 2361.855f, 58.14614f)), owning_building_guid = 43)
      LocalObject(1901, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(1903, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4366.28f, 2378.102f, 55.70214f)), owning_building_guid = 43)
      LocalObject(1904, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 43)
      LocalObject(2229, ProximityTerminal.Constructor(repair_silo, Vector3(4298.309f, 2445.637f, 47.22264f)), owning_building_guid = 43)
      LocalObject(2230, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 43)
      LocalObject(2233, ProximityTerminal.Constructor(repair_silo, Vector3(4356.637f, 2311.208f, 47.24414f)), owning_building_guid = 43)
      LocalObject(2234, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 43)
      LocalObject(1557, FacilityTurret.Constructor(manned_turret, Vector3(4213.906f, 2502.855f, 55.99314f)), owning_building_guid = 43)
      TurretToWeapon(1557, 5052)
      LocalObject(1558, FacilityTurret.Constructor(manned_turret, Vector3(4219.413f, 2304.665f, 55.99314f)), owning_building_guid = 43)
      TurretToWeapon(1558, 5053)
      LocalObject(1559, FacilityTurret.Constructor(manned_turret, Vector3(4303.601f, 2502.855f, 55.99314f)), owning_building_guid = 43)
      TurretToWeapon(1559, 5054)
      LocalObject(1560, FacilityTurret.Constructor(manned_turret, Vector3(4384.154f, 2304.657f, 55.99314f)), owning_building_guid = 43)
      TurretToWeapon(1560, 5055)
      LocalObject(1561, FacilityTurret.Constructor(manned_turret, Vector3(4384.154f, 2442.398f, 55.99314f)), owning_building_guid = 43)
      TurretToWeapon(1561, 5056)
      LocalObject(1562, FacilityTurret.Constructor(manned_turret, Vector3(4391.881f, 2369.423f, 55.99314f)), owning_building_guid = 43)
    ...
    def Building14(): Unit = { // Name: Tumas Type: tech_plant GUID: 46, MapID: 14
      LocalBuilding(46, 14, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(4610f, 6292f, 69.42805f))))
      ...
      LocalObject(147, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 46)
      LocalObject(1630, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4614.166f, 6291.997f, 82.00605f), Vector3(0, 0, -89)), owning_building_guid = 46, terminal_guid = 147)
      LocalObject(148, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 46)
      LocalObject(1631, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4614.532f, 6313.012f, 82.00605f), Vector3(0, 0, -89)), owning_building_guid = 46, terminal_guid = 148)
      LocalObject(1720, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1721, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1722, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(1723, Terminal.Constructor(order_terminal), owning_building_guid = 46)
      LocalObject(2443, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2444, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2445, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2447, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2448, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2449, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2455, Terminal.Constructor(spawn_terminal), owning_building_guid = 46)
      LocalObject(2652, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 46)
      LocalObject(1633, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(4638.818f, 6243.435f, 46.96505f), Vector3(0, 0, -89)), owning_building_guid = 46, terminal_guid = 2652)
      ...
      LocalObject(1649, ProximityTerminal.Constructor(medical_terminal, Vector3(4637.082f, 6331.978f, 54.52805f)), owning_building_guid = 46)
      LocalObject(1650, ProximityTerminal.Constructor(medical_terminal, Vector3(4647.147f, 6294.411f, 74.52505f)), owning_building_guid = 46)
      LocalObject(1906, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4617.45f, 6250.844f, 79.97805f)), owning_building_guid = 46)
      LocalObject(1907, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(1912, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4633.266f, 6230.289f, 77.62305f)), owning_building_guid = 46)
      LocalObject(1913, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(1915, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4637.086f, 6359.817f, 77.63605f)), owning_building_guid = 46)
      LocalObject(1916, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(1918, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4653.22f, 6353.242f, 80.08005f)), owning_building_guid = 46)
      LocalObject(1919, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(1924, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4674.68f, 6300.251f, 84.87505f)), owning_building_guid = 46)
      LocalObject(1925, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(1927, ProximityTerminal.Constructor(pad_landing_frame, Vector3(4691.805f, 6316.11f, 77.63605f)), owning_building_guid = 46)
      LocalObject(1928, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 46)
      LocalObject(2237, ProximityTerminal.Constructor(repair_silo, Vector3(4568.375f, 6293.035f, 69.15655f)), owning_building_guid = 46)
      LocalObject(2238, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 46)
      LocalObject(2249, ProximityTerminal.Constructor(repair_silo, Vector3(4703.802f, 6349.008f, 69.17805f)), owning_building_guid = 46)
      LocalObject(2250, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 46)
      LocalObject(1563, FacilityTurret.Constructor(manned_turret, Vector3(4509.692f, 6209.644f, 77.92705f)), owning_building_guid = 46)
      TurretToWeapon(1563, 5058)
      LocalObject(1564, FacilityTurret.Constructor(manned_turret, Vector3(4511.258f, 6299.325f, 77.92705f)), owning_building_guid = 46)
      TurretToWeapon(1564, 5059)
      LocalObject(1565, FacilityTurret.Constructor(manned_turret, Vector3(4573.111f, 6378.811f, 77.92705f)), owning_building_guid = 46)
      TurretToWeapon(1565, 5060)
      LocalObject(1569, FacilityTurret.Constructor(manned_turret, Vector3(4646.21f, 6385.263f, 77.92705f)), owning_building_guid = 46)
      TurretToWeapon(1569, 5061)
      LocalObject(1570, FacilityTurret.Constructor(manned_turret, Vector3(4707.948f, 6211.691f, 77.92705f)), owning_building_guid = 46)
      TurretToWeapon(1570, 5062)
      LocalObject(1571, FacilityTurret.Constructor(manned_turret, Vector3(4710.832f, 6376.407f, 77.92705f)), owning_building_guid = 46)
    ...
    def Building10(): Unit = { // Name: Mekala Type: tech_plant GUID: 49, MapID: 10
      LocalBuilding(49, 10, FoundationBuilder(Building.Structure(StructureType.Facility, Vector3(5986f, 3002f, 58.83252f))))
      ...
      LocalObject(149, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 49)
      LocalObject(1637, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5986.07f, 2997.835f, 71.41052f), Vector3(0, 0, 0)), owning_building_guid = 49, terminal_guid = 149)
      LocalObject(150, Terminal.Constructor(air_vehicle_terminal), owning_building_guid = 49)
      LocalObject(1638, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(6007.088f, 2997.835f, 71.41052f), Vector3(0, 0, 0)), owning_building_guid = 49, terminal_guid = 150)
      LocalObject(1764, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1765, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1766, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(1767, Terminal.Constructor(order_terminal), owning_building_guid = 49)
      LocalObject(2469, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2470, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2471, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2472, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2473, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2474, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2475, Terminal.Constructor(spawn_terminal), owning_building_guid = 49)
      LocalObject(2655, Terminal.Constructor(ground_vehicle_terminal), owning_building_guid = 49)
      LocalObject(1636, VehicleSpawnPad.Constructor(mb_pad_creation, Vector3(5937.945f, 2972.339f, 36.36952f), Vector3(0, 0, 0)), owning_building_guid = 49, terminal_guid = 2655)
      ...
      LocalObject(1656, ProximityTerminal.Constructor(medical_terminal, Vector3(5989.059f, 2964.901f, 63.92952f)), owning_building_guid = 49)
      LocalObject(1657, ProximityTerminal.Constructor(medical_terminal, Vector3(6026.444f, 2975.62f, 43.93253f)), owning_building_guid = 49)
      LocalObject(1960, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5924.704f, 2977.661f, 67.02753f)), owning_building_guid = 49)
      LocalObject(1961, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(1963, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5944.98f, 2993.833f, 69.38252f)), owning_building_guid = 49)
      LocalObject(1964, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(1966, ProximityTerminal.Constructor(pad_landing_frame, Vector3(5995.379f, 2937.474f, 74.27953f)), owning_building_guid = 49)
      LocalObject(1967, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(1969, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6011.534f, 2920.628f, 67.04053f)), owning_building_guid = 49)
      LocalObject(1970, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(1972, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6047.987f, 2959.855f, 69.48453f)), owning_building_guid = 49)
      LocalObject(1973, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(1975, ProximityTerminal.Constructor(pad_landing_frame, Vector3(6054.28f, 2976.102f, 67.04053f)), owning_building_guid = 49)
      LocalObject(1976, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 49)
      LocalObject(2269, ProximityTerminal.Constructor(repair_silo, Vector3(5986.309f, 3043.637f, 58.56102f)), owning_building_guid = 49)
      LocalObject(2270, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 49)
      LocalObject(2273, ProximityTerminal.Constructor(repair_silo, Vector3(6044.637f, 2909.208f, 58.58252f)), owning_building_guid = 49)
      LocalObject(2274, Terminal.Constructor(ground_rearm_terminal), owning_building_guid = 49)
      LocalObject(1596, FacilityTurret.Constructor(manned_turret, Vector3(5901.906f, 3100.855f, 67.33152f)), owning_building_guid = 49)
      TurretToWeapon(1596, 5064)
      LocalObject(1597, FacilityTurret.Constructor(manned_turret, Vector3(5907.413f, 2902.665f, 67.33152f)), owning_building_guid = 49)
      TurretToWeapon(1597, 5065)
      LocalObject(1598, FacilityTurret.Constructor(manned_turret, Vector3(5991.601f, 3100.855f, 67.33152f)), owning_building_guid = 49)
      TurretToWeapon(1598, 5066)
      LocalObject(1599, FacilityTurret.Constructor(manned_turret, Vector3(6072.154f, 2902.657f, 67.33152f)), owning_building_guid = 49)
      TurretToWeapon(1599, 5067)
      LocalObject(1600, FacilityTurret.Constructor(manned_turret, Vector3(6072.154f, 3040.398f, 67.33152f)), owning_building_guid = 49)
      TurretToWeapon(1600, 5068)
      LocalObject(1601, FacilityTurret.Constructor(manned_turret, Vector3(6079.881f, 2967.423f, 67.33152f)), owning_building_guid = 49)
    ...
    def Building19(): Unit = { // Name: E_Ikanam_Tower Type: tower_a GUID: 52, MapID: 19
      LocalBuilding(52, 19, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(2994f, 2306f, 52.08814f))))
      ...
      LocalObject(1671, Terminal.Constructor(order_terminal), owning_building_guid = 52)
      LocalObject(1672, Terminal.Constructor(order_terminal), owning_building_guid = 52)
      LocalObject(1673, Terminal.Constructor(order_terminal), owning_building_guid = 52)
      LocalObject(2312, SpawnTube.Constructor(respawn_tube_tower, Vector3(3004.706f, 2293.742f, 41.57014f), Vector3(0, 0, 0)), owning_building_guid = 52)
      LocalObject(2313, SpawnTube.Constructor(respawn_tube_tower, Vector3(3004.706f, 2310.152f, 41.57014f), Vector3(0, 0, 0)), owning_building_guid = 52)
      LocalObject(1526, FacilityTurret.Constructor(manned_turret, Vector3(2981.32f, 2293.295f, 71.03014f)), owning_building_guid = 52)
      TurretToWeapon(1526, 5070)
      LocalObject(1527, FacilityTurret.Constructor(manned_turret, Vector3(3016.647f, 2318.707f, 71.03014f)), owning_building_guid = 52)
    ...
    def Building34(): Unit = { // Name: W_Qumu_Tower Type: tower_a GUID: 53, MapID: 34
      LocalBuilding(53, 34, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3448f, 5518f, 54.41446f))))
      ...
      LocalObject(1684, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1685, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(1686, Terminal.Constructor(order_terminal), owning_building_guid = 53)
      LocalObject(2321, SpawnTube.Constructor(respawn_tube_tower, Vector3(3458.706f, 5505.742f, 43.89646f), Vector3(0, 0, 0)), owning_building_guid = 53)
      LocalObject(2322, SpawnTube.Constructor(respawn_tube_tower, Vector3(3458.706f, 5522.152f, 43.89646f), Vector3(0, 0, 0)), owning_building_guid = 53)
      LocalObject(1539, FacilityTurret.Constructor(manned_turret, Vector3(3435.32f, 5505.295f, 73.35646f)), owning_building_guid = 53)
      TurretToWeapon(1539, 5072)
      LocalObject(1540, FacilityTurret.Constructor(manned_turret, Vector3(3470.647f, 5530.707f, 73.35646f)), owning_building_guid = 53)
    ...
    def Building20(): Unit = { // Name: NE_Cetan_Tower Type: tower_a GUID: 54, MapID: 20
      LocalBuilding(54, 20, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3912f, 3212f, 43.86781f))))
      ...
      LocalObject(1707, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(1708, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(1709, Terminal.Constructor(order_terminal), owning_building_guid = 54)
      LocalObject(2333, SpawnTube.Constructor(respawn_tube_tower, Vector3(3922.706f, 3199.742f, 33.34982f), Vector3(0, 0, 0)), owning_building_guid = 54)
      LocalObject(2334, SpawnTube.Constructor(respawn_tube_tower, Vector3(3922.706f, 3216.152f, 33.34982f), Vector3(0, 0, 0)), owning_building_guid = 54)
      LocalObject(1549, FacilityTurret.Constructor(manned_turret, Vector3(3899.32f, 3199.295f, 62.80981f)), owning_building_guid = 54)
      TurretToWeapon(1549, 5074)
      LocalObject(1552, FacilityTurret.Constructor(manned_turret, Vector3(3934.647f, 3224.707f, 62.80981f)), owning_building_guid = 54)
    ...
    def Building32(): Unit = { // Name: NW_Sungrey_Tower Type: tower_a GUID: 55, MapID: 32
      ...
      LocalObject(1733, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(1734, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(1735, Terminal.Constructor(order_terminal), owning_building_guid = 55)
      LocalObject(2350, SpawnTube.Constructor(respawn_tube_tower, Vector3(4836.706f, 5247.742f, 77.84319f), Vector3(0, 0, 0)), owning_building_guid = 55)
      LocalObject(2351, SpawnTube.Constructor(respawn_tube_tower, Vector3(4836.706f, 5264.152f, 77.84319f), Vector3(0, 0, 0)), owning_building_guid = 55)
      LocalObject(1578, FacilityTurret.Constructor(manned_turret, Vector3(4813.32f, 5247.295f, 107.3032f)), owning_building_guid = 55)
      TurretToWeapon(1578, 5076)
      LocalObject(1579, FacilityTurret.Constructor(manned_turret, Vector3(4848.647f, 5272.707f, 107.3032f)), owning_building_guid = 55)
    ...
    def Building23(): Unit = { // Name: E_Kyoi_Tower Type: tower_a GUID: 56, MapID: 23
      LocalBuilding(56, 23, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(5458f, 2004f, 81.14763f))))
      ...
      LocalObject(1754, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1755, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(1756, Terminal.Constructor(order_terminal), owning_building_guid = 56)
      LocalObject(2363, SpawnTube.Constructor(respawn_tube_tower, Vector3(5468.706f, 1991.742f, 70.62963f), Vector3(0, 0, 0)), owning_building_guid = 56)
      LocalObject(2364, SpawnTube.Constructor(respawn_tube_tower, Vector3(5468.706f, 2008.152f, 70.62963f), Vector3(0, 0, 0)), owning_building_guid = 56)
      LocalObject(1586, FacilityTurret.Constructor(manned_turret, Vector3(5445.32f, 1991.295f, 100.0896f)), owning_building_guid = 56)
      TurretToWeapon(1586, 5078)
      LocalObject(1590, FacilityTurret.Constructor(manned_turret, Vector3(5480.647f, 2016.707f, 100.0896f)), owning_building_guid = 56)
    ...
    def Building28(): Unit = { // Name: W_Azeban_Tower Type: tower_a GUID: 57, MapID: 28
      ...
      LocalObject(1761, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1762, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(1763, Terminal.Constructor(order_terminal), owning_building_guid = 57)
      LocalObject(2368, SpawnTube.Constructor(respawn_tube_tower, Vector3(5564.706f, 5313.742f, 32.54831f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(2369, SpawnTube.Constructor(respawn_tube_tower, Vector3(5564.706f, 5330.152f, 32.54831f), Vector3(0, 0, 0)), owning_building_guid = 57)
      LocalObject(1592, FacilityTurret.Constructor(manned_turret, Vector3(5541.32f, 5313.295f, 62.00831f)), owning_building_guid = 57)
      TurretToWeapon(1592, 5080)
      LocalObject(1593, FacilityTurret.Constructor(manned_turret, Vector3(5576.647f, 5338.707f, 62.00831f)), owning_building_guid = 57)
    ...
    def Building48(): Unit = { // Name: Azeban_Tower Type: tower_a GUID: 58, MapID: 48
      LocalBuilding(58, 48, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(6176f, 5550f, 49.46858f))))
      ...
      LocalObject(1771, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1772, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(1773, Terminal.Constructor(order_terminal), owning_building_guid = 58)
      LocalObject(2375, SpawnTube.Constructor(respawn_tube_tower, Vector3(6186.706f, 5537.742f, 38.95058f), Vector3(0, 0, 0)), owning_building_guid = 58)
      LocalObject(2376, SpawnTube.Constructor(respawn_tube_tower, Vector3(6186.706f, 5554.152f, 38.95058f), Vector3(0, 0, 0)), owning_building_guid = 58)
      LocalObject(1604, FacilityTurret.Constructor(manned_turret, Vector3(6163.32f, 5537.295f, 68.41058f)), owning_building_guid = 58)
      TurretToWeapon(1604, 5082)
      LocalObject(1607, FacilityTurret.Constructor(manned_turret, Vector3(6198.647f, 5562.707f, 68.41058f)), owning_building_guid = 58)
    ...
    def Building30(): Unit = { // Name: S_Ceryshen_Warpgate_Tower Type: tower_a GUID: 59, MapID: 30
      LocalBuilding(59, 30, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(6302f, 6398f, 106.5124f))))
      ...
      LocalObject(1782, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1783, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(1784, Terminal.Constructor(order_terminal), owning_building_guid = 59)
      LocalObject(2380, SpawnTube.Constructor(respawn_tube_tower, Vector3(6312.706f, 6385.742f, 95.99438f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(2381, SpawnTube.Constructor(respawn_tube_tower, Vector3(6312.706f, 6402.152f, 95.99438f), Vector3(0, 0, 0)), owning_building_guid = 59)
      LocalObject(1609, FacilityTurret.Constructor(manned_turret, Vector3(6289.32f, 6385.295f, 125.4544f)), owning_building_guid = 59)
      TurretToWeapon(1609, 5084)
      LocalObject(1612, FacilityTurret.Constructor(manned_turret, Vector3(6324.647f, 6410.707f, 125.4544f)), owning_building_guid = 59)
    ...
    def Building16(): Unit = { // Name: NE_Solsar_Warpgate_Tower Type: tower_b GUID: 60, MapID: 16
      LocalBuilding(60, 16, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(1910f, 1664f, 43.16405f))))
      ...
      LocalObject(1661, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1662, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(1663, Terminal.Constructor(order_terminal), owning_building_guid = 60)
      LocalObject(2305, SpawnTube.Constructor(respawn_tube_tower, Vector3(1920.706f, 1651.742f, 32.64605f), Vector3(0, 0, 0)), owning_building_guid = 60)
      LocalObject(2306, SpawnTube.Constructor(respawn_tube_tower, Vector3(1920.706f, 1668.152f, 32.64605f), Vector3(0, 0, 0)), owning_building_guid = 60)
    }

    Building26()

    def Building26(): Unit = { // Name: NE_NCSanc_Warpgate_Tower Type: tower_b GUID: 61, MapID: 26
      LocalBuilding(61, 26, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3488f, 4702f, 60.32801f))))
      ...
      LocalObject(1691, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1692, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(1693, Terminal.Constructor(order_terminal), owning_building_guid = 61)
      LocalObject(2323, SpawnTube.Constructor(respawn_tube_tower, Vector3(3498.706f, 4689.742f, 49.81001f), Vector3(0, 0, 0)), owning_building_guid = 61)
      LocalObject(2324, SpawnTube.Constructor(respawn_tube_tower, Vector3(3498.706f, 4706.152f, 49.81001f), Vector3(0, 0, 0)), owning_building_guid = 61)
    }

    Building21()

    def Building21(): Unit = { // Name: SE_Heyoka_Tower Type: tower_b GUID: 62, MapID: 21
      LocalBuilding(62, 21, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(4456f, 2654f, 69.41827f))))
      ...
      LocalObject(1717, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1718, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(1719, Terminal.Constructor(order_terminal), owning_building_guid = 62)
      LocalObject(2340, SpawnTube.Constructor(respawn_tube_tower, Vector3(4466.706f, 2641.742f, 58.90028f), Vector3(0, 0, 0)), owning_building_guid = 62)
      LocalObject(2341, SpawnTube.Constructor(respawn_tube_tower, Vector3(4466.706f, 2658.152f, 58.90028f), Vector3(0, 0, 0)), owning_building_guid = 62)
    }

    Building24()

    def Building24(): Unit = { // Name: NE_Heyoka_Tower Type: tower_b GUID: 63, MapID: 24
      LocalBuilding(63, 24, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(4702f, 3278f, 55.6656f))))
      ...
      LocalObject(1730, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1731, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(1732, Terminal.Constructor(order_terminal), owning_building_guid = 63)
      LocalObject(2348, SpawnTube.Constructor(respawn_tube_tower, Vector3(4712.706f, 3265.742f, 45.1476f), Vector3(0, 0, 0)), owning_building_guid = 63)
      LocalObject(2349, SpawnTube.Constructor(respawn_tube_tower, Vector3(4712.706f, 3282.152f, 45.1476f), Vector3(0, 0, 0)), owning_building_guid = 63)
    }

    Building31()

    def Building31(): Unit = { // Name: SE_Tumas_Tower Type: tower_b GUID: 64, MapID: 31
      LocalBuilding(64, 31, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(4988f, 6190f, 41.46329f))))
      ...
      LocalObject(1745, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1746, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(1747, Terminal.Constructor(order_terminal), owning_building_guid = 64)
      LocalObject(2357, SpawnTube.Constructor(respawn_tube_tower, Vector3(4998.706f, 6177.742f, 30.94529f), Vector3(0, 0, 0)), owning_building_guid = 64)
      LocalObject(2358, SpawnTube.Constructor(respawn_tube_tower, Vector3(4998.706f, 6194.152f, 30.94529f), Vector3(0, 0, 0)), owning_building_guid = 64)
    }

    Building25()

    def Building25(): Unit = { // Name: S_Oshur_Warpgate_Tower Type: tower_b GUID: 65, MapID: 25
      LocalBuilding(65, 25, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(5122f, 4320f, 59.33499f))))
      ...
      LocalObject(1748, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1749, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(1750, Terminal.Constructor(order_terminal), owning_building_guid = 65)
      LocalObject(2359, SpawnTube.Constructor(respawn_tube_tower, Vector3(5132.706f, 4307.742f, 48.81699f), Vector3(0, 0, 0)), owning_building_guid = 65)
      LocalObject(2360, SpawnTube.Constructor(respawn_tube_tower, Vector3(5132.706f, 4324.152f, 48.81699f), Vector3(0, 0, 0)), owning_building_guid = 65)
    }

    Building17()

    def Building17(): Unit = { // Name: NW_Ikanam_Tower Type: tower_c GUID: 66, MapID: 17
      LocalBuilding(66, 17, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(2224f, 2782f, 52.59641f))))
      ...
      LocalObject(1664, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1665, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(1666, Terminal.Constructor(order_terminal), owning_building_guid = 66)
      LocalObject(2307, SpawnTube.Constructor(respawn_tube_tower, Vector3(2234.706f, 2769.742f, 42.07841f), Vector3(0, 0, 0)), owning_building_guid = 66)
      LocalObject(2308, SpawnTube.Constructor(respawn_tube_tower, Vector3(2234.706f, 2786.152f, 42.07841f), Vector3(0, 0, 0)), owning_building_guid = 66)
      LocalObject(2002, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2222.907f, 2776.725f, 80.16641f)), owning_building_guid = 66)
      LocalObject(2003, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 66)
      LocalObject(2005, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(2222.907f, 2787.17f, 80.16641f)), owning_building_guid = 66)
      LocalObject(2006, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 66)
      LocalObject(1519, FacilityTurret.Constructor(manned_turret, Vector3(2209.07f, 2767.045f, 71.53841f)), owning_building_guid = 66)
      TurretToWeapon(1519, 5086)
      LocalObject(1520, FacilityTurret.Constructor(manned_turret, Vector3(2247.497f, 2796.957f, 71.53841f)), owning_building_guid = 66)
    ...
    def Building35(): Unit = { // Name: N_Onatha_Tower Type: tower_c GUID: 67, MapID: 35
      LocalBuilding(67, 35, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3352f, 6674f, 57.33703f))))
      ...
      LocalObject(1678, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1679, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(1680, Terminal.Constructor(order_terminal), owning_building_guid = 67)
      LocalObject(2317, SpawnTube.Constructor(respawn_tube_tower, Vector3(3362.706f, 6661.742f, 46.81903f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(2318, SpawnTube.Constructor(respawn_tube_tower, Vector3(3362.706f, 6678.152f, 46.81903f), Vector3(0, 0, 0)), owning_building_guid = 67)
      LocalObject(2008, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3350.907f, 6668.725f, 84.90703f)), owning_building_guid = 67)
      LocalObject(2009, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 67)
      LocalObject(2011, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3350.907f, 6679.17f, 84.90703f)), owning_building_guid = 67)
      LocalObject(2012, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 67)
      LocalObject(1530, FacilityTurret.Constructor(manned_turret, Vector3(3337.07f, 6659.045f, 76.27903f)), owning_building_guid = 67)
      TurretToWeapon(1530, 5088)
      LocalObject(1533, FacilityTurret.Constructor(manned_turret, Vector3(3375.497f, 6688.957f, 76.27903f)), owning_building_guid = 67)
    ...
    def Building18(): Unit = { // Name: NW_Cetan_Tower Type: tower_c GUID: 68, MapID: 18
      LocalBuilding(68, 18, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3368f, 3472f, 49.55655f))))
      ...
      LocalObject(1681, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(1682, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(1683, Terminal.Constructor(order_terminal), owning_building_guid = 68)
      LocalObject(2319, SpawnTube.Constructor(respawn_tube_tower, Vector3(3378.706f, 3459.742f, 39.03855f), Vector3(0, 0, 0)), owning_building_guid = 68)
      LocalObject(2320, SpawnTube.Constructor(respawn_tube_tower, Vector3(3378.706f, 3476.152f, 39.03855f), Vector3(0, 0, 0)), owning_building_guid = 68)
      LocalObject(2014, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3366.907f, 3466.725f, 77.12656f)), owning_building_guid = 68)
      LocalObject(2015, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 68)
      LocalObject(2017, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3366.907f, 3477.17f, 77.12656f)), owning_building_guid = 68)
      LocalObject(2018, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 68)
      LocalObject(1531, FacilityTurret.Constructor(manned_turret, Vector3(3353.07f, 3457.045f, 68.49855f)), owning_building_guid = 68)
      TurretToWeapon(1531, 5090)
      LocalObject(1534, FacilityTurret.Constructor(manned_turret, Vector3(3391.497f, 3486.957f, 68.49855f)), owning_building_guid = 68)
    ...
    def Building47(): Unit = { // Name: Cetan_Tower Type: tower_c GUID: 69, MapID: 47
      LocalBuilding(69, 47, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(3686f, 2664f, 68.50925f))))
      ...
      LocalObject(1697, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1698, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(1699, Terminal.Constructor(order_terminal), owning_building_guid = 69)
      LocalObject(2328, SpawnTube.Constructor(respawn_tube_tower, Vector3(3696.706f, 2651.742f, 57.99125f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(2329, SpawnTube.Constructor(respawn_tube_tower, Vector3(3696.706f, 2668.152f, 57.99125f), Vector3(0, 0, 0)), owning_building_guid = 69)
      LocalObject(2020, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3684.907f, 2658.725f, 96.07925f)), owning_building_guid = 69)
      LocalObject(2021, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 69)
      LocalObject(2023, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3684.907f, 2669.17f, 96.07925f)), owning_building_guid = 69)
      LocalObject(2024, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 69)
      LocalObject(1545, FacilityTurret.Constructor(manned_turret, Vector3(3671.07f, 2649.045f, 87.45125f)), owning_building_guid = 69)
      TurretToWeapon(1545, 5092)
      LocalObject(1546, FacilityTurret.Constructor(manned_turret, Vector3(3709.497f, 2678.957f, 87.45125f)), owning_building_guid = 69)
    ...
    def Building33(): Unit = { // Name: NW_Oshur_Warpgate_Tower Type: tower_c GUID: 70, MapID: 33
      LocalBuilding(70, 33, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(4000f, 5430f, 66.66187f))))
      ...
      LocalObject(1710, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1711, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(1712, Terminal.Constructor(order_terminal), owning_building_guid = 70)
      LocalObject(2335, SpawnTube.Constructor(respawn_tube_tower, Vector3(4010.706f, 5417.742f, 56.14388f), Vector3(0, 0, 0)), owning_building_guid = 70)
      LocalObject(2336, SpawnTube.Constructor(respawn_tube_tower, Vector3(4010.706f, 5434.152f, 56.14388f), Vector3(0, 0, 0)), owning_building_guid = 70)
      LocalObject(2026, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3998.907f, 5424.725f, 94.23187f)), owning_building_guid = 70)
      LocalObject(2027, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 70)
      LocalObject(2029, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(3998.907f, 5435.17f, 94.23187f)), owning_building_guid = 70)
      LocalObject(2030, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 70)
      LocalObject(1555, FacilityTurret.Constructor(manned_turret, Vector3(3985.07f, 5415.045f, 85.60387f)), owning_building_guid = 70)
      TurretToWeapon(1555, 5094)
      LocalObject(1556, FacilityTurret.Constructor(manned_turret, Vector3(4023.497f, 5444.957f, 85.60387f)), owning_building_guid = 70)
    ...
    def Building22(): Unit = { // Name: NW_Kyoi_Tower Type: tower_c GUID: 71, MapID: 22
      LocalBuilding(71, 22, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(4978f, 2646f, 62.90847f))))
      ...
      LocalObject(1742, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1743, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(1744, Terminal.Constructor(order_terminal), owning_building_guid = 71)
      LocalObject(2355, SpawnTube.Constructor(respawn_tube_tower, Vector3(4988.706f, 2633.742f, 52.39047f), Vector3(0, 0, 0)), owning_building_guid = 71)
      LocalObject(2356, SpawnTube.Constructor(respawn_tube_tower, Vector3(4988.706f, 2650.152f, 52.39047f), Vector3(0, 0, 0)), owning_building_guid = 71)
      LocalObject(2032, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4976.907f, 2640.725f, 90.47847f)), owning_building_guid = 71)
      LocalObject(2033, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 71)
      LocalObject(2035, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(4976.907f, 2651.17f, 90.47847f)), owning_building_guid = 71)
      LocalObject(2036, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 71)
      LocalObject(1581, FacilityTurret.Constructor(manned_turret, Vector3(4963.07f, 2631.045f, 81.85047f)), owning_building_guid = 71)
      TurretToWeapon(1581, 5096)
      LocalObject(1582, FacilityTurret.Constructor(manned_turret, Vector3(5001.497f, 2660.957f, 81.85047f)), owning_building_guid = 71)
    ...
    def Building29(): Unit = { // Name: W_Ceryshen_Warpgate_Tower Type: tower_c GUID: 72, MapID: 29
      LocalBuilding(72, 29, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(5424f, 7052f, 61.30546f))))
      ...
      LocalObject(1751, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1752, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(1753, Terminal.Constructor(order_terminal), owning_building_guid = 72)
      LocalObject(2361, SpawnTube.Constructor(respawn_tube_tower, Vector3(5434.706f, 7039.742f, 50.78746f), Vector3(0, 0, 0)), owning_building_guid = 72)
      LocalObject(2362, SpawnTube.Constructor(respawn_tube_tower, Vector3(5434.706f, 7056.152f, 50.78746f), Vector3(0, 0, 0)), owning_building_guid = 72)
      LocalObject(2038, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5422.907f, 7046.725f, 88.87546f)), owning_building_guid = 72)
      LocalObject(2039, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 72)
      LocalObject(2041, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(5422.907f, 7057.17f, 88.87546f)), owning_building_guid = 72)
      LocalObject(2042, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 72)
      LocalObject(1585, FacilityTurret.Constructor(manned_turret, Vector3(5409.07f, 7037.045f, 80.24746f)), owning_building_guid = 72)
      TurretToWeapon(1585, 5098)
      LocalObject(1587, FacilityTurret.Constructor(manned_turret, Vector3(5447.497f, 7066.957f, 80.24746f)), owning_building_guid = 72)
    ...
    def Building46(): Unit = { // Name: Mekala_Tower Type: tower_c GUID: 73, MapID: 46
      LocalBuilding(73, 46, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(6134f, 3198f, 54.44196f))))
      ...
      LocalObject(1768, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1769, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(1770, Terminal.Constructor(order_terminal), owning_building_guid = 73)
      LocalObject(2373, SpawnTube.Constructor(respawn_tube_tower, Vector3(6144.706f, 3185.742f, 43.92396f), Vector3(0, 0, 0)), owning_building_guid = 73)
      LocalObject(2374, SpawnTube.Constructor(respawn_tube_tower, Vector3(6144.706f, 3202.152f, 43.92396f), Vector3(0, 0, 0)), owning_building_guid = 73)
      LocalObject(2044, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6132.907f, 3192.725f, 82.01196f)), owning_building_guid = 73)
      LocalObject(2045, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 73)
      LocalObject(2047, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6132.907f, 3203.17f, 82.01196f)), owning_building_guid = 73)
      LocalObject(2048, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 73)
      LocalObject(1602, FacilityTurret.Constructor(manned_turret, Vector3(6119.07f, 3183.045f, 73.38396f)), owning_building_guid = 73)
      TurretToWeapon(1602, 5100)
      LocalObject(1603, FacilityTurret.Constructor(manned_turret, Vector3(6157.497f, 3212.957f, 73.38396f)), owning_building_guid = 73)
    ...
    def Building27(): Unit = { // Name: NW_Xelas_Tower Type: tower_c GUID: 74, MapID: 27
      LocalBuilding(74, 27, FoundationBuilder(Building.Structure(StructureType.Tower, Vector3(6444f, 4606f, 49.63475f))))
      ...
      LocalObject(1785, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1786, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(1787, Terminal.Constructor(order_terminal), owning_building_guid = 74)
      LocalObject(2382, SpawnTube.Constructor(respawn_tube_tower, Vector3(6454.706f, 4593.742f, 39.11674f), Vector3(0, 0, 0)), owning_building_guid = 74)
      LocalObject(2383, SpawnTube.Constructor(respawn_tube_tower, Vector3(6454.706f, 4610.152f, 39.11674f), Vector3(0, 0, 0)), owning_building_guid = 74)
      LocalObject(2050, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6442.907f, 4600.725f, 77.20474f)), owning_building_guid = 74)
      LocalObject(2051, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 74)
      LocalObject(2053, ProximityTerminal.Constructor(pad_landing_tower_frame, Vector3(6442.907f, 4611.17f, 77.20474f)), owning_building_guid = 74)
      LocalObject(2054, Terminal.Constructor(air_rearm_terminal), owning_building_guid = 74)
      LocalObject(1616, FacilityTurret.Constructor(manned_turret, Vector3(6429.07f, 4591.045f, 68.57674f)), owning_building_guid = 74)
